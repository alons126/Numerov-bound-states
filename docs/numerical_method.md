...
for the special energies $E$ that satisfy the required boundary behavior. This makes the problem a boundary-value eigenvalue problem rather than a standard initial-value problem.
