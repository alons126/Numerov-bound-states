...
\title{Project Outline and Motivation 3 \\ Updated Notes}
\author{Alon Sportes}
\date{}
...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item \texttt{quartic\_oscillator()},
    ...
    \begin{itemize}
        ...
        \item quartic double well: tunneling and energy splitting,
        \item quartic oscillator: optional extra demonstration,
    ...
    Important latest detail: \texttt{initial\_conditions()} now includes higher Taylor terms so the first Numerov step does not reduce the convergence order. This fixed the square-well convergence slope problem.
    ...
    \begin{itemize}
        ...
        \item \texttt{run\_quartic\_oscillator\_demo()},
    ...
    \begin{itemize}
        ...
        \item root-finding diagnostics are now generated for the double well,
        \item double-well convergence versus grid spacing is included,
        \item double-well convergence versus box size is included,
        \item double-well convergence uses a high-resolution numerical reference instead of pretending there is an exact analytic solution.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item root-finding diagnostics,
        \item convergence versus $h$,
        \item convergence versus $x_{\max}$,
        \item a high-resolution reference solution.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item high-resolution numerical reference for non-analytic potentials,
