...
\begin{document}
    ...
    \section{Computational approach}
        ...
        \subsection{Shooting and root finding}
            ...
            \end{align}
            Eigenvalues correspond to the roots of $M(E)=0$, which are located by bracketing sign changes and then refined numerically. To make the procedure transparent, we plot the mismatch versus $E$ and mark the bisection iterates; the diagnostic figures use an $L^2$-scaled version of the mismatch, meaning the raw mismatch is divided by the half-domain norm $\|\psi_E\|_2$. This leaves the zeros unchanged while making the vertical axis easier to interpret across different potentials. Zero crossings identify the allowed energies. \\
    ...
    \section{Results}
        ...
        \subsection{Infinite square well}
            ...
            \begin{figure}[p]
                ...
                \begin{minipage}[t]{\textwidth}
                    ...
                    \captionof{figure}{$L^2$-scaled boundary mismatch functions for even (a) and odd (b) states. The zero crossings correspond to the physical eigenvalues found by the shooting method.}
        ...
        \subsection{Harmonic oscillator}
            \subsubsection{Numerov method on unbounded domains}
                ...
                The shooting mismatch functions (Fig.~\ref{fig:ho_shooting}) exhibit clear zero crossings at the expected energies. In the even sector the roots lie near $E\approx0.5$ and $E\approx2.5$, while in the odd sector they lie near $E\approx1.5$ and $E\approx3.5$. The plotted mismatch is scaled by $\|\psi_E\|_2$ for readability, so the curves remain visually well behaved while preserving the same root locations used by the solver. The sign changes remain sharp and the roots alternate even--odd as they should. \\
                ...
                \begin{figure}[p]
                    ...
                    \begin{minipage}[t]{\textwidth}
                        ...
                        \captionof{figure}{$L^2$-scaled boundary mismatch functions for even (a) and odd (b) states. The zero crossings correspond to the physical eigenvalues.}
        ...
        \subsection{Double-well potential}
            ...
            \begin{figure}[p]
                ...
                \begin{minipage}[t]{\textwidth}
                    ...
                    \captionof{figure}{$L^2$-scaled shooting mismatch functions for even (top) and odd (bottom) double-well states. The zero crossings define the numerical eigenvalues.}
