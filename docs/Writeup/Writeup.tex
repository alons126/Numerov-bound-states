    ...
    \section{Results}
        ...
        \subsection{Infinite square well}
            \begin{figure}[!t]
                ...
                \begin{minipage}[t]{0.48\textwidth}
                    \centering
                    \includegraphics[height=5cm]{../../results/1_infinite_square_well_Numerov/1_infinite_square_well_Numerov_state_energy_comparison.png}
            ...
            \begin{figure}[t]
                ...
                \begin{minipage}[t]{0.48\textwidth}
                    \centering
                    \includegraphics[height=5cm]{../../results/1_infinite_square_well_Numerov/1_infinite_square_well_Numerov_energy_convergence_vs_h.png}
        ...
        \subsection{Harmonic oscillator}
            \subsubsection{Numerov method on unbounded domains}
                ...
                \begin{figure}[!h]
                    ...
                    \begin{minipage}[t]{0.48\textwidth}
                        \centering
                        \includegraphics[height=5cm]{../../results/2a_harmonic_oscillator_Numerov/2a_harmonic_oscillator_Numerov_energy_convergence_vs_h.png}
                    ...
                    \begin{minipage}[t]{0.48\textwidth}
                        \centering
                        \includegraphics[height=5cm]{../../results/2a_harmonic_oscillator_Numerov/2a_harmonic_oscillator_Numerov_energy_convergence_vs_x_max.png}
            ...
            \subsubsection{Numerov versus Runge--Kutta}
                ...
                \begin{figure}[!h]
                    ...
                    \begin{minipage}[t]{0.48\textwidth}
                        \centering
                        \includegraphics[height=5cm]{../../results/2c_harmonic_oscillator_Numerov_VS_RK4_comparison/2c_harmonic_oscillator_Numerov_VS_RK4_state_error_comparison.png}
        ...
        \subsection{Double-well potential}
            ...
            \begin{figure}[h]
                ...
                \begin{minipage}[t]{0.48\textwidth}
                    \centering
                    \includegraphics[height=5cm]{../../results/3_double_well_Numerov/3_double_well_Numerov_energy_splitting_vs_b.png}
        ...
        \subsection{Scattering and resonant tunneling}
            ...
            \subsubsection{Double barrier potential}
                ...
                \begin{figure}[h]
                    ...
                    \begin{minipage}[t]{0.48\textwidth}
                        \centering
                        \includegraphics[height=5cm]{../../results/6_scattering_double_barrier_Numerov/6_scattering_double_barrier_Numerov_transmission_reflection.png}
                    ...
                    \begin{minipage}[t]{0.48\textwidth}
                        \centering
                        \includegraphics[height=5cm]{../../results/6_scattering_double_barrier_Numerov/6_scattering_double_barrier_Numerov_state_probability_density.png}
