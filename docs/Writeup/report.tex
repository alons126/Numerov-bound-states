        ...
        \subsection{Double-well potential}
            ...
            \begin{figure}[p]
                ...
                \begin{minipage}[t]{0.48\textwidth}
                    ...
                    \captionof{figure}{Dependence of the double-well energy errors on box size, measured relative to a larger-box reference calculation at approximately fixed grid spacing. The errors decrease rapidly as the domain is enlarged and then reach a numerical plateau.}
