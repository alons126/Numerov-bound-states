    ...
    \section{Results}
        ...
        \subsection{Infinite square well}
            ...
            \begin{figure}[h]
                ...
                \caption{Boundary mismatch functions for even (a) and odd (b) states. The zero crossings correspond to the physical eigenvalues found by the shooting method.}
        ...
        \subsection{Harmonic oscillator}
            \subsubsection{Numerov method on unbounded domains}
                ...
                \begin{figure}[h]
                    ...
                    \caption{Boundary mismatch functions for even (a) and odd (b) states. The zero crossings correspond to the physical eigenvalues.}
